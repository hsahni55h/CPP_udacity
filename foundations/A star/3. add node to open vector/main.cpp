...
//    Write an AddToOpen function which accepts the following arguments:
...
//        Create a vector<int> node with the form {x, y, g, h} and push the 
//        node to the back of the open vector.
//        Set the grid value for the x and y coordinates to the enum value 
//        kClosed. We have added kClosed to the set of enum values.
